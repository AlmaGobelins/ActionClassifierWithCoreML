...
class PalettePredictor {
    ...
    static func createImageClassifier() -> VNCoreMLModel {
        ...
        let imageClassifierWrapper = try? PalettePlaceholderModel(configuration: defaultConfig)
    ...
    private func createImageClassificationRequest() -> VNImageBasedRequest {
        ...
        let imageClassificationRequest = VNCoreMLRequest(model: PalettePredictor.imageClassifier,
