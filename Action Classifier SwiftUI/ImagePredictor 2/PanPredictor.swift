...
class PanPredictor {
    ...
    static func createImageClassifier() -> VNCoreMLModel {
        ...
        let imageClassifierWrapper = try? PanPlaceholderModel(configuration: defaultConfig)
    ...
    private func createImageClassificationRequest() -> VNImageBasedRequest {
        ...
        let imageClassificationRequest = VNCoreMLRequest(model: PanPredictor.imageClassifier,
